---
title: "inovick_peercommentary_nirmitin_hw_04"
...
```
##IN-- I think that we may need to make an "exemplar" population sort of thing, like "pop <- c(rep(0, 500), rep(1, 500))" and that's where you get the proportion values from to plug in? I am also struggling pretty hard with this.

I found this format and am going to try to adjust it to see if I can modify the parameters that way. I don't know if this is helpful:
#
Z.prop.test()
...
##In-- I think you also need a figure legend on your graph
```{r}
...
##IN-- I think so? Or you can just compare their slopes?
```{r}
