...
<br>
*For lm(), β1 is estimated to be 1.2180 while for loglm(), β1 is estimated to be 0.23415. This fits the alternate hypothesis since β1 ≠ 0. β1lm > β1log(lm) but I'm not sure how to interpret this due to the nature of the adjusted slope of a log function.*
```{r}
summary(lm)
...
<br>
*Overall, I think that the normal lm model is better because more data points fall into it's 90% confidence and prediction intervals.*